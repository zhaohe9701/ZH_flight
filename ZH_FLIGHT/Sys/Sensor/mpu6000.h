...
#define GODR_8000Hz 0x00
#define GODR_1000Hz 0x00
#define GODR_500Hz 0x01
...
private:
    ...
    uint16_t _acc_lsb = 2048;
    int16_t _bias_acc_x = 40;
    int16_t _bias_acc_y = 0;
    int16_t _bias_acc_z = 170;
    int16_t _bias_gyro_x = -12;
    int16_t _bias_gyro_y = 23;
    int16_t _bias_gyro_z = -10;
};
